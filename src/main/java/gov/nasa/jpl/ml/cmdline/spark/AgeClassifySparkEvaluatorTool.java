...
import gov.nasa.jpl.ml.cmdline.params.SparkEvaluatorToolParams;
...
public class AgeClassifySparkEvaluatorTool 
    extends AbstractEvaluatorTool<AuthorAgeSample, SparkEvaluatorToolParams> {

    public AgeClassifySparkEvaluatorTool() {
	super(AuthorAgeSample.class, SparkEvaluatorToolParams.class);
    }
	 ...
	 if ("".equals(format) || StreamFactoryRegistry.DEFAULT_FORMAT.equals(format)) {
	     return getBasicHelp(paramsClass,
				 ...
				 .<SparkEvaluatorToolParams>getParameters());
	 } else {
		 ...
		 ArgumentParser.createUsage(paramsClass, factory.<SparkEvaluatorToolParams>getParameters());
	 }
     }
