...
/**
 * Generates a detailed report for the Age Classifier.
 * <p>
...
public class AgeClassifyFineGrainedReportListener implements AgeClassifyEvaluationMonitor {
     ...
     */
    public AgeClassifyFineGrainedReportListener() {
	this(System.err);
    }
     ...
     */
    public AgeClassifyFineGrainedReportListener(OutputStream outputStream) {
    ...
    public void correctlyClassified(AuthorAgeSample reference,
				    AuthorAgeSample prediction) {
	stats.add(reference, prediction);
    }
	...
	public void add(AuthorAgeSample reference, AuthorAgeSample prediction) {
